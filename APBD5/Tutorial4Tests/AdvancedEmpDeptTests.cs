...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnFirstTwoHiredEmployees()
    {
        var emps = Database.GetEmps();
         ...
         var firstTwo = emps.OrderBy(e => e.DeptNo).Take(2).ToList(); 
    ...
    public void ShouldReturnDistinctJobTitles()
    {
        ...
        var jobs = emps.Distinct().Select(j=>j.Job).ToList(); 
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        ...
        var withMgr = emps.Where(m => m.Mgr != null).ToList();
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = from e in emps
            ...
            join s in grades on e.Sal equals s.Losal into temp1
            from s in grades
